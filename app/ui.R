...
page_navbar(
  ...
  nav_panel(
    ...
    div(
      ...
      p("L'objectif de cette application est de visualiser les statistiques sportives individuelles de chaques joueurs en fonction de leurs postes. Cet outil permet d'identifier les profils sur-performants et de fournir une aide visuelle au recrutement et de déterminer les profils de joueurs les plus intéréssant.", 
